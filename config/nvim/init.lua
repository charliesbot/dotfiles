...
-- Vertical split keymaps
vim.keymap.set('n', '<leader>v', '<cmd>vsplit<CR>', { desc = 'Vertical split current buffer' })
vim.keymap.set('n', '<leader>V', '<cmd>vnew<CR>', { desc = 'Vertical split with new buffer' })
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          -- Show hover information for the word under your cursor.
          --  Most language servers provide documentation, type information, etc.
          map('gh', vim.lsp.buf.hover, 'Show [H]over Documentation')
...
-- [[ Treesitter (native in Neovim 0.12+) ]]
-- Highlighting and indentation are built-in; parser installation handled by tree-sitter-manager.
vim.api.nvim_create_autocmd('FileType', {
  callback = function()
...
-- Custom keymaps and configurations beyond the base kickstart setup

-- Ctrl-P for file finding (similar to popular plugins)
local builtin = require 'telescope.builtin'
vim.keymap.set('n', '<C-p>', builtin.find_files, { desc = 'Find files' })

-- Ctrl-F for searching across project
vim.keymap.set('n', '<C-f>', builtin.live_grep, { desc = 'Search across project' })
